  ...
  return (
    <div style={{
      ...
      <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
        ...
        >
          <h2 style={{ fontSize: '12px', letterSpacing: '5px', color: 'rgba(255, 180, 120, 0.8)', textTransform: 'uppercase' }}>Eksperti</h2>
          <h1 style={{ fontSize: '48px', fontWeight: '900', marginTop: '10px' }}>Naš Tim</h1>
        </motion.div>
